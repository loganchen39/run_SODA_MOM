...
set START_MONTH           = $4
set START_DAY             = $5
set DIR_CODE_MOM_ORG      = $6
set DIR_INPUT_DATA_MOM    = $7
set DIR_ROOT_RUN_MOM      = $8
...
cd $DIR_CODE_MOM_ORG           # have to have this for "root" to be correct
set root          = $cwd       # or the upper-level directory: $cwd:h
echo root         = $root 
set code_dir      = $root/src
rm work
ln -sf $DIR_ROOT_RUN_MOM/MOM_org ./work
...
# ln -sf $DIR_INPUT_DATA_MOM/forcing/ERA_I/2016_2017/*.nc .
...
if ($name == 19800101) then
    ...
    ln -sf $DIR_ROOT_RUN_MOM/MOM_SODA/$STR_PREV_CYCLE/RESTART/*   .
endif
rm -f data_table
rm -f field_table
rm -f diag_table
...
# cp $DIR_INPUT_DATA_MOM/forcing/ERA_I/nml_table_soda342a/19790101_20161231/diag_table_forecast           ./diag_table
# cp $DIR_INPUT_DATA_MOM/forcing/ERA_I/nml_table_soda342a/19790101_20161231/input_forecast.nml            ./input.nml.template
...
cp $DIR_INPUT_DATA_MOM/forcing/ERA_I/nml_table_soda342a/soda342_run/diag_table_forecast           ./diag_table
cp $DIR_INPUT_DATA_MOM/forcing/ERA_I/nml_table_soda342a/soda342_run/input_forecast.nml            ./input.nml.template
